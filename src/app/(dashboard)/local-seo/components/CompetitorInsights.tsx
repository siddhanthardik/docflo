...
import { AlertCircle, Star, RefreshCw, ChevronDown, ChevronUp, Sparkles, Plus, MessageSquare, Edit3, ShieldCheck, Award, Layers, MapPin } from "lucide-react";
...
function CompetitiveBenchmarkMatrix({ competitors, doctorRating = 0, doctorReviewCount = 0, userRank = 5, overviewData }: { competitors: any[]; doctorRating?: number; doctorReviewCount?: number; userRank?: number; overviewData?: any }) {
...
export function CompetitorInsights() {
  ...
  return (
    <div className="space-y-0">
      {/* 4-Pillar Side-by-Side Competitive Benchmark Matrix */}
      <CompetitiveBenchmarkMatrix competitors={allRows} doctorRating={doctorRating} doctorReviewCount={doctorReviewCount} userRank={userRank} overviewData={overviewData} />
        ...
        {displayList.map((comp, idx) => {
          if (comp.isYou) {
            return (
              <div
                key="you-row"
                className="flex flex-col md:grid md:grid-cols-[1fr_auto_auto_auto_auto] gap-2 md:gap-x-4 px-3 py-4 md:py-3 items-center bg-indigo-50/80 rounded-xl border-2 border-indigo-200 shadow-xs"
              >
                ...
                <div className="flex items-center gap-6 md:gap-0 w-full col-span-4 md:grid md:grid-cols-4 md:items-center">
                  ...
                  <div className="md:w-16 text-center flex items-center justify-center text-xs font-semibold text-indigo-700">
                    Your Clinic
                  </div>
          ...
          return (
            <div
              ...
              className="flex flex-col md:grid md:grid-cols-[1fr_auto_auto_auto_auto] gap-2 md:gap-x-4 px-3 py-4 md:py-3 hover:bg-gray-50/50 transition-colors group"
            >
